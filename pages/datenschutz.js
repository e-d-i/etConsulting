  ...
  return (
    <div className={styles.container}>
      <section className={styles.sectionContainer1}>
        <h1 className={styles.h1}>Datenschutz</h1>
        <h2 className={styles.h2}>Datenschutzerkl&auml;rung</h2>
        <h3 className={styles.h3}>1. Datenschutz auf einen Blick</h3>
        <h4 className={styles.h4}>Allgemeine Hinweise</h4>
        ...
        <h4 className={styles.h4}>Datenerfassung auf dieser Website</h4>
        <div className={styles.para}>
          <p className={styles.p}>
          ...
          <p className={styles.p}>
            ...
            ITSysteme erfasst. Das sind vor allem technische Daten &#x00028;z.
      ...
      <section className={styles.sectionContainer2}>
        <h3 className={styles.h3}>2. Hosting</h3>
        <div className={styles.para}>
          <p className={styles.p}>
            Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
          </p>
        </div>
        <h4 className={styles.h4}>Externes Hosting</h4>
        <div className={styles.para}>
          <p className={styles.p}>
          ...
          <p className={styles.p}>
            ...
            &#x00028;Art. 6 Abs. 1 lit. b DSGVO&#x00029; und im Interesse einer
          ...
          <p className={styles.p}>
            ...
            insoweit verarbeiten, wie dies zur Erf&uuml;llung seiner
      ...
      <section className={styles.sectionContainer3}>
        ...
        <h4 className={styles.h4}>Datenschutz</h4>
        <div className={styles.para}>
          <p className={styles.p}>
        ...
        <h4 className={styles.h4}>Hinweis zur verantwortlichen Stelle</h4>
        <div className={styles.para}>
          <p className={styles.p}>
          ...
          <p className={styles.p}>
            ...
            B. Namen, E-Mail-Adressen o. &Auml;.&#x00029; entscheidet.
          </p>
        </div>
        <h4 className={styles.h4}>Speicherdauer</h4>
        <div className={styles.para}>
          <p className={styles.p}>
        ...
        <h4 className={styles.h4}>Recht auf Daten&uuml;bertragbarkeit</h4>
        <div className={styles.para}>
          <p className={styles.p}>
        ...
        <h4 className={styles.h4}>Auskunft, L&ouml;schung und Berichtigung</h4>
        <div className={styles.para}>
          <p className={styles.p}>
        ...
        <div className={styles.para}>
          ...
          <p className={styles.p}>
            &bull; Wenn Sie die Richtigkeit Ihrer bei uns gespeicherten
            ...
            <br />
            &bull; Wenn die Verarbeitung Ihrer personenbezogenen Daten
            ...
            verlangen.
            <br />
            &bull; Wenn wir Ihre personenbezogenen Daten nicht mehr
            ...
            Verarbeitung Ihrer personenbezogenen Daten zu verlangen.
            <br />
            &bull; Wenn Sie einen Widerspruch nach Art. 21 Abs. 1 DSGVO
          ...
          <p className={styles.p}>
            ...
            eingeschr&auml;nkt haben, d&uuml;rfen diese Daten – von ihrer
      ...
      <section className={styles.sectionContainer4}>
        <h3 className={styles.h3}>4. Datenerfassung auf dieser Website</h3>
        <h4 className={styles.h4}>Kontaktformular</h4>
        <div className={styles.para}>
          <p className={styles.p}>
        ...
        <h4 className={styles.h4}>Anfrage per E-Mail, Telefon oder Telefax</h4>
        <div className={styles.para}>
          <p className={styles.p}>
